...
def r_type_instruction(line):
    ...
    if(len(data1)==2 and len(data2)==3 and data1[0] in r_function3.keys() and data2[0] in registers.keys() and data2[1] in registers.keys() and data2[2] in registers.keys()):
        binary=["0110011",str(reg_binary_calc(data2[0])),str(r_function3[data1[0]]),str(reg_binary_calc(data2[1])),str(reg_binary_calc(data2[2])),"0000000"]
        binary1=["0110011",str(reg_binary_calc(data2[0])),str(r_function3[data1[0]]),str(reg_binary_calc(data2[1])),str(reg_binary_calc(data2[2])),"0100000"]
